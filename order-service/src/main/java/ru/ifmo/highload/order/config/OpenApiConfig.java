    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("Order management. JWT or X-User-Id/X-User-Roles required for create and my orders.")
                        .version("1.0"))
                ...
                .components(new Components()
                        ...
                        .addSecuritySchemes(X_USER_ROLES,
                                new SecurityScheme()
                                        ...
                                        .in(SecurityScheme.In.HEADER)
                                        .name("X-User-Roles")
                                        .description("Roles without ROLE_ prefix, e.g. SUPERVISOR or USER,SUPERVISOR")));
    }
}
