...
class CategoryServiceImplTest {
    ...
    @Test
    void getAllCategories_WhenNoCategories_ShouldReturnEmptyPage() {
        Pageable pageable = PageRequest.of(0, 10);
    ...
    @Test
    void createCategory_WithParentCategory_ShouldCreateCategory() {
        CategoryCreateRequest request = new CategoryCreateRequest();
        ...
        savedCategory.setParentCategoryId(1L);
    ...
    void updateCategory_WhenCategoryExists_ShouldUpdateAndReturnCategory() {
        ...
        updatedCategory.setParentCategoryId(parentCategoryId);
    ...
    void updateCategory_WhenParentIdIsNull_ShouldUpdateCategory() {
        ...
        updatedCategory.setId(categoryId);
        updatedCategory.setName("Updated");
        updatedCategory.setParentCategoryId(null);
    ...
    void updateCategory_WithDuplicateName_ShouldThrowException() {
        ...
        when(categoryRepository.findById(categoryId)).thenReturn(Optional.of(existingCategory));
        when(categoryRepository.existsByNameAndParentCategoryId("Duplicate", parentCategoryId)).thenReturn(true);
